...
#ifndef _OPENCL_HIDINGS_H_
#define _OPENCL_HIDINGS_H_
...
// general
inline artificial_neural_network::offset_type get_global_id(size_t offset)     { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::global_id[offset]);     } // global index
inline artificial_neural_network::offset_type get_global_size(size_t offset)   { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::global_size[offset]);   } // global range
inline artificial_neural_network::offset_type get_local_id(size_t offset)      { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::local_id[offset]);      } // local index within group
inline artificial_neural_network::offset_type get_local_size(size_t offset)    { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::local_size[offset]);    } // group size
inline artificial_neural_network::offset_type get_num_groups(size_t offset)    { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::num_groups[offset]);    } // number of groups
inline artificial_neural_network::offset_type get_group_id(size_t offset)      { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::group_id[offset]);      } // group ID
inline artificial_neural_network::offset_type get_global_offset(size_t offset) { return artificial_neural_network::Convert<size_t, artificial_neural_network::offset_type>(artificial_neural_network::openClEmulator::global_offset[offset]); } // global offset
inline void __attribute__(auto arg) {}
...
// integer functions
//#define abs(x) std::abs(x) // |x|
//#define clz(x) (x) // count leading 0 bits, slow, instead use as_uint((float)((x&0x07FF)<<12))>>23
...
//#define pow(x,y) std::pow((x), (y))// x^y
...
//#define sqrt(x) std::sqrt(x)// x^(1/2), slower, use native_sqrt(x) instead
